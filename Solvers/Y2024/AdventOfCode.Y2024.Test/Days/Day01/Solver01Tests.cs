...
namespace AdventOfCode.Y2024.Test.Days.Day01;

using AdventOfCode.Y2024.Days.Day01;
...
public class Solver01Tests : TestFixture
{
    ...
    /// </summary>
    public Solver01Tests() => this.solver = new(inputFilePath: this.InputFilePath());
    ...
    [Fact]
    public async Task Solve_1_ReturnsExpected() => (await this.solver.Solve_1()).Should().Be("11");
    ...
    /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
    [Fact]
    public async Task Solve_2_ReturnsExpected() => (await this.solver.Solve_2()).Should().Be("31");
}
