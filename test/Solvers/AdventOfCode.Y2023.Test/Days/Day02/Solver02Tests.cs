...
namespace AdventOfCode.Y2023.Test.Days.Day02;

using AdventOfCode.Y2023.Days.Day02;
...
public class Solver02Tests : TestFixture
{
    ...
    /// </summary>
    public Solver02Tests() => this.solver = new Solver02(inputFilePath: this.InputFilePath());
